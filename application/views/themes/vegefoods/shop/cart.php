...
<section class="ftco-section ftco-Keranjang Belanja bg-warning">
  <div class="container">
        ...
        <div class="row justify-content-end">
          <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
            <div class="cart-total mb-3 bg-white">
              <h3 class="text-dark">Kode Kupon</h3>
              <p class="text-dark">Punya kode kupon? Gunakan kupon kamu untuk mendapatkan potongan harga menarik</p>

              <div class="form-group">
                <label for="code">Kode:</label>
                <input id="code" name="coupon_code" type="text" class="form-control text-left px-3 bg-light" placeholder="">
              </div>
          ...
          <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
            ...
            <p><button type="submit" class="btn btn-success py-3 px-4">Checkout</button></p>
          </div>
        </div>
      </form>
    <?php else : ?>
