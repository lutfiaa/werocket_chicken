...
<body class="@yield('sidebar_type') bg-warning">
  <!-- Sidenav -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/orders'); ?>">
                <i class="fa fa-file-invoice text-darkr"></i>
                <span class="nav-link-text text-dark">Pesanan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/products/coupons'); ?>">
                <i class="fa fa-money-bill-alt text-dark"></i>
                <span class="nav-link-text text-dark">Kupon</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/payments'); ?>">
                <i class="fa fa-money-bill-alt text-dark"></i>
                <span class="nav-link-text text-dark">Pembayaran</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/customers'); ?>">
                <i class="fa fa-users text-dark"></i>
                <span class="nav-link-text text-dark">Pelanggan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/reviews'); ?>">
                <i class="fa fa-edit text-dark"></i>
                <span class="nav-link-text text-dark">Review Pelanggan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/contacts'); ?>">
                <i class="fa fa-comment text-dark"></i>
                <span class="nav-link-text text-dark">mesengger</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('auth/logout'); ?>">
                <i class="fa fa-sign text-dark"></i>
                <span class="nav-link-text text-dark">Logout</span>
              </a>
            </li>
          </ul>
        </div>
