            ...
            <div class="card card-primary ">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="title" class="form-control-label text-dark">Judul Review</label>
                        <input type="text" name="title" value="<?php echo set_value('title'); ?>" class="form-control bg-light" id="title" required>
                        <?php echo form_error('title'); ?>
                    </div>

                    <div class="form-group">
                        <label for="orders" class="form-control-label text-dark">Order:</label>
                    ...
                    <div class="form-group">
                        <label for="review" class="form-control-label text-dark">Review</label>
                ...
                <div class="card-footer">
                    <input type="submit" value="Tulis Review" class="btn btn-danger">
                </div>
                </form>
            </div>
        </div>
