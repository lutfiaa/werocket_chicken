    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="<?php echo site_url('customer'); ?>" class="nav-link">dashboard</a></li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              <a class="dropdown-item" href="<?php echo site_url('customer/orders'); ?>">order saya</a>
              <a class="dropdown-item" href="<?php echo site_url('customer/payments'); ?>">Pembayaran</a>
            </div>
          </li>
          <li class="nav-item"><a href="<?php echo site_url('customer/reviews'); ?>" class="nav-link">review</a></li>
          <li class="nav-item"><a href="<?php echo site_url('customer/profile'); ?>" class="nav-link">profil</a></li>
          <li class="nav-item"><a href="<?php echo site_url('auth/logout'); ?>" class="nav-link">Logout</a></li>
