...
class Profile extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('name', 'Nama Lengkap', 'required|max_length[16]|min_length[4]');
        if ($this->form_validation->run() === FALSE) {
            ...
            $profile_picture = $this->profile->get_profile();
            $old_profile = $profile_picture->profile_picture;
